		...
		<>
			...
			<section className='origins'>
				...
				<p>
					...
					organisms, it belongs to a growing class of what are called
				...
				<p>
					...
					cognitive scientist Daniel Dennett has used the analogy of the Game of
					Life "universe" extensively to illustrate the possible evolution of
					complex philosophical constructs, such as consciousness and free will,
					from the relatively simple set of deterministic physical laws which
					might govern our universe.
				</p>
				<p>
